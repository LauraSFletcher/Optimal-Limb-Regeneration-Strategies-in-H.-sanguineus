...
missing_limbs <- 1 #Determines the number of missing limbs each individual has. 
...
H <- 0.35 #A measure of diet quality, or the average percentage of diet comprised of animal tissue (Griffen and Mosblack, 2011).
